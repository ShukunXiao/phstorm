...
function restaurant_food_delivery_open_menu() {
...
jQuery( "button.menu-toggle").on("click", restaurant_food_delivery_open_menu);

function restaurant_food_delivery_close_menu() {
  jQuery('button.close-menu').removeClass('close-panal');
  jQuery('nav#main-menu').hide();
}

jQuery( "button.close-menu").on("click", restaurant_food_delivery_close_menu);
