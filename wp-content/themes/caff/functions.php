 ...
 */
function caff_resource_hints( $urls, $relation_type ) {
	if ( wp_style_is( 'caff-fonts', 'queue' ) && 'preconnect' === $relation_type ) {
		$urls[] = array(
...
add_filter( 'wp_resource_hints', 'caff_resource_hints', 10, 2 );
