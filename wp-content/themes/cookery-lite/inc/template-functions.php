    ...
    <div class="footer-bottom">
		<div class="container">
            ...
            <?php
                ...
                echo '<a href="' . esc_url( 'https://blossomthemes.com/downloads/cookery-lite-free-wordpress-theme/' ) .'" rel="nofollow" target="_blank">' . esc_html__( 'Blossom Themes', 'cookery-lite' ) . '</a>.';                
