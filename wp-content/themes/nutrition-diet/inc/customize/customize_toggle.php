 ...
 * @access public
 */
class Nutrition_Diet_Toggle_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_style( 'nutrition-diet-toggle-control-styles', get_parent_theme_file_uri( 'assets/css/toggle.css' ), false, '1.0.0', 'all' );
	}
