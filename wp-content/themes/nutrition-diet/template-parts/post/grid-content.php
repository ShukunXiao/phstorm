...
<?php $post_option = get_theme_mod( 'nutrition_diet_grid_column','3_column');
			...
			<div class="postbox smallpostimage p-2 mb-3">
	        	...
	        	<div class="overlay pt-2 text-center">
	        		<div class="date-box mb-2">
	        			<?php if( get_theme_mod('nutrition_diet_date',true) != ''){ ?>
	        				<span class="mr-2"><i class="far fa-calendar-alt mr-2"></i><?php the_time( get_option( 'date_format' ) ); ?></span>
	        			<?php } ?>
	        			<?php if( get_theme_mod('nutrition_diet_admin',true) != ''){ ?>
	        			...
	        			<?php }?>
	        			<?php if( get_theme_mod('nutrition_diet_comment',true) != ''){ ?>
	      					<span class="entry-comments"><i class="fas fa-comments mr-2"></i> <?php comments_number( __('0 Comments','nutrition-diet'), __('0 Comments','nutrition-diet'), __('% Comments','nutrition-diet')); ?></span>
	      				<?php }?>
	    			</div>
	        		<p><?php the_excerpt();?></p>
	        	</div>
